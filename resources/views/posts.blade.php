        ...
        <div class="card-body">
          ...
          <p>
            <small class="text-muted">
                <h6>By: <a href="/users/{{ $posts[0]->author->username }}" class="text-decoration-none" >{{ $posts[0]->author->name }}</a></h6>
                <h6><a href="/categories/{{$posts[0]->category->slug}}" class="text-decoration-none">{{$posts[0]->category->name}}</a></h6>
